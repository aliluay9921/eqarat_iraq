...
Route::middleware(['auth:api', 'active'])->group(function () {
    ...
    Route::delete("delete_image", [ServicesController::class, 'deleteImage']);

    Route::put('updateToken', [AuthController::class, 'updateFcm'])->name('updateFcm');
    Route::post('sendNotification', [NotificationController::class, 'sendMessage']);
